...
import {
  Text, View, ImageBackground, Platform, BackHandler, ActivityIndicator, FlatList
} from 'react-native';
       ...
       <ProgressBar
        ...
        />
           <View style={Styles.container}>
            <View style={[CommonCss.cardView, Platform.OS=='ios' ? CommonCss.shadowIos : CommonCss.shadow, {marginTop:10, flex:1}]}>
                  <ScrollableTabView
                  ...
                  >
                    ...
                    {this.state.posData.length<1 && (
                        <View style={{alignItems:'center', width:'100%', alignSelf:'center', position:'absolute', top:20}}>
                          <Text style={{fontSize:Utils.headSize, textAlign:'center', color:Utils.colorText}}>No Record Found !</Text>
                        </View>
                      )}
                      <FlatList
