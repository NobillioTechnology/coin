...
import {
  Text, View, Image, TextInput, ScrollView, TouchableHighlight, AsyncStorage, BackHandler, Modal
} from 'react-native';
               ...
               <Text style={{backgroundColor:Utils.colorGray, height:1, width:'90%', alignSelf:'center', marginTop:5}}/>
                 <TextInput
                   ...
                   <View style={{flexDirection:'row', marginLeft:18}}>
                     <TextInput
                       style={this.state.validatePassword==false ? Styles.inputPassError : Styles.inputPass}
                       ...
                       />
                      <Icon name="eye" style={Styles.iconForPassword} onPress={()=>this.setState({hiddenPass:!this.state.hiddenPass})}/>
                   </View>
