...
import {
  Text, View, TextInput, ScrollView, Dimensions, CheckBox, TouchableHighlight, BackHandler, ImageBackground,
          ...
          <View style={[Styles.container]}>
            ...
            <View style={Styles.radioView}>
              ...
              <View style={Styles.radioView}>
                {Platform.OS!='ios' ? 
                (
                <CheckBox value={this.state.showMEReal} onValueChange={(showMEReal)=>this.setState({showMEReal})} onPress={()=>this.setState({showMEReal:!this.state.showMEReal})} style={Platform.OS=='ios' ? {width:20, height:20}:{}}/>
                ):(
                <CheckBoxIos isChecked = {this.state.showMEReal} onClick={()=>this.setState({showMEReal:!this.state.showMEReal})}/>
                )}
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.disableSensitive} onClick={()=>this.setState({disableSensitive:!this.state.disableSensitive})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.enableWebNoti} onClick={()=>this.setState({enableWebNoti:!this.state.enableWebNoti})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.sellingVacation} onClick={()=>this.setState({sellingVacation:!this.state.sellingVacation})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.buyingVacation} onClick={()=>this.setState({buyingVacation:!this.state.buyingVacation})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.smsNotiForTrade} onClick={()=>this.setState({smsNotiForTrade:!this.state.smsNotiForTrade})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.smsNotiForPayment} onClick={()=>this.setState({smsNotiForPayment:!this.state.smsNotiForPayment})}/>
                ):(
              ...
              <View style={Styles.radioView}>
                {Platform.OS=='ios' ? 
                (
                <CheckBoxIos isChecked = {this.state.smsNotiForEscrow} onClick={()=>this.setState({smsNotiForEscrow:!this.state.smsNotiForEscrow})}/>
                ):(
