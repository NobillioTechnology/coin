...
import {
  Text, View, Image, TextInput, ScrollView, Dimensions, Platform, TouchableHighlight, BackHandler, ImageBackground
} from 'react-native';
      ...
      <View style={Styles.body}>
       ...
       <Header title={this.state.role+' Bitcoin'} menuCheck="false" data={this.props} style={Styles.header}/>
        ...
        <ScrollView style={{flex:0.8}} keyboardShouldPersistTaps={'always'}>
          <View style={[Styles.container, Platform.OS=='ios' ? {marginBottom:200} :{}]}>
            <View style={[Styles.itemBody, {marginTop:10}]}>
              ...
              <View style={Styles.row}>
                ...
                <Text style={Styles.tradeText}>{this.refineLimit(this.state.minLimit)} - {this.refineLimit(this.state.maxLimit)}</Text>
              </View>
              <View style={Styles.row}>
                <Text style={Styles.tradeTextBold}>Price/BTC:</Text>
                <Text style={Styles.tradeText}>{this.refineBtc(this.state.priceBtc)}</Text>
              </View>
              <View style={Styles.row}>
              ...
              <Text style={Styles.heading}>{this.state.role=='Buy' ? 'How much you want to buy?' : 'How may you wish to sell?'}</Text>
                <View style={Styles.row}>
                  ...
                  <View style={[Styles.row, Styles.amountView]}>
                    <TextInput style={[Styles.amountBtc, Platform.OS=='ios' ? {height:50} : {}]}
